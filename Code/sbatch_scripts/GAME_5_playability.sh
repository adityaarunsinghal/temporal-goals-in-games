...
#SBATCH --job-name=game5
#SBATCH --nodes=1
#SBATCH --open-mode=append
#SBATCH --output=./slurm_logs/%j_game5.out
#SBATCH --error=./slurm_logs/%j_game5.err
#SBATCH --export=ALL
...
python3 /scratch/as11919/temporal-goals-in-games/Code/GAME_5_SOLVER.py
