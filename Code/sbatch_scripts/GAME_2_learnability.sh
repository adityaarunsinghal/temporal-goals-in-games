...
#SBATCH --job-name=game2
#SBATCH --nodes=1
#SBATCH --open-mode=append
#SBATCH --output=./slurm_logs/%j_game2.out
#SBATCH --error=./slurm_logs/%j_game2.err
#SBATCH --export=ALL
...
python3 /scratch/as11919/temporal-goals-in-games/Code/GAME_2_LEARNER.py
