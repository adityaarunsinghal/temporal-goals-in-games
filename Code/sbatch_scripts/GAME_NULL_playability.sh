...
#SBATCH --job-name=gameNull
#SBATCH --nodes=1
#SBATCH --open-mode=append
#SBATCH --output=./slurm_logs/%j_gameNull.out
#SBATCH --error=./slurm_logs/%j_gameNull.err
#SBATCH --export=ALL
...
python3 /scratch/as11919/temporal-goals-in-games/Code/GAME_NULL_SOLVER.py
