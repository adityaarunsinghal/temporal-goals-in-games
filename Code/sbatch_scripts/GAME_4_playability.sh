...
#SBATCH --job-name=game4
#SBATCH --nodes=1
#SBATCH --open-mode=append
#SBATCH --output=./slurm_logs/%j_game4.out
#SBATCH --error=./slurm_logs/%j_game4.err
#SBATCH --export=ALL
...
python3 /scratch/as11919/temporal-goals-in-games/Code/GAME_4_SOLVER.py
